...
def DeleteFile():
  print("delete file")
  print(os.listdir("."))
  prompt = input("select a file to be deleted and type it in: ")
  os.remove(prompt)
...
#DeleteDirectory()
#Allows for you to delete a given directory
...
def DeleteDirectory():
  ...
  if os.listdir(DeletionItem) == []:
    ...
    if prompt.capitalize().find("Y") == 0:
      ...
      print("my apologies, I did not understand your response")
  else:
